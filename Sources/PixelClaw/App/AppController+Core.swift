...
extension AppController {
    ...
    func beginAppleSeek(now: TimeInterval) {
        ...
        appleSeekHopTriggers.removeAll()
        isAsleep = false
        wakingUp = crabView.sitAmount > 0.05 || crabView.eyeClose > 0.05
        autoTargetX = nil
    ...
    func levelForApple(_ apple: AppleState) -> CrabLevel {
        ...
        return abs(apple.floorY - dockFloor) < abs(apple.floorY - groundFloor) ? .dock : .ground
    }
    ...
    func isFullyAwake() -> Bool {
        ...
        return !isAsleep
            ...
            && crabView.sitAmount < 0.05
            && crabView.eyeClose < 0.05
    }
